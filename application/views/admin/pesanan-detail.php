...
<div class="row">
	...
	<div class="col-sm-12">
		...
		<form action="<?=site_url('admin/pesanan/bayar/'.$data['id'])?>" method="POST" enctype="multipart/form-data" class="ui form">
			<div class="field">
			...
			<?php endif; ?>
				<a href="<?=site_url('admin/pesanan')?>" class="ui button">KEMBALI</a>
