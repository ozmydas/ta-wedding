...
<div class="row">
	...
	<div class="col-sm-12 col-md-4 col-lg-3" style="background: #666; padding-top: 20px;">
		...
		<div class="list-group">
			<a href="<?=site_url('member/barang/')?>" class="list-group-item">Semua Kategori</a>
			<?php foreach($kategori as $key => $value): ?>
			<a href="<?=site_url('member/barang/index/'.$value['id'])?>" class="list-group-item"><?=$value['kategori']?></a>
			<?php endforeach; ?>
		</div>
	</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4" style="margin-bottom: 20px">
					<div class="card">
						...
						<div class="card-body">
							...
							<a href="<?=site_url('member/barang/sewa/'.$value['id'])?>" class="btn btn-default" style="background: pink; color: #fff">SEWA</a>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
